...
* @{
*/
#define PRODUCT_KEY "c95f1c522bcf4f5792cea7268f5ec73f"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "194e739c49ae48eea139f480694893e8"
...
* @{
*/
#define Filtrate_BYTEOFFSET                    0
#define Filtrate_BITOFFSET                     0
#define Filtrate_LEN                           1
#define Feed_food_BYTEOFFSET                    5
#define Feed_food_BITOFFSET                     0
#define Feed_food_LEN                           1

#define Template_write_RATIO                         0.1
#define Template_write_ADDITION                      0
#define Template_write_MIN                           0
#define Template_write_MAX                           1000
#define Feed_time_RATIO                         1
#define Feed_time_ADDITION                      0
#define Feed_time_MIN                           0
#define Feed_time_MAX                           65535
#define Template_read_RATIO                         0.1
#define Template_read_ADDITION                      0
#define Template_read_MIN                           0
#define Template_read_MAX                           1000
/**@} */
...
typedef struct {
  bool valueFiltrate;
  float valueTemplate_write;
  uint32_t valueFeed_time;
  bool valueFeed_food;
  float valueTemplate_read;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagFiltrate:1;
  uint8_t flagTemplate_write:1;
  uint8_t flagFeed_time:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint16_t valueTemplate_write;
  uint16_t valueFeed_time;
} attrVals_t;
